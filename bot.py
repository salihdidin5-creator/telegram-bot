...
# ---------- AYARLAR ----------
TELEGRAM_TOKEN = os.getenv("8199299680:AAGUONCVNwZVhLtZb1Eq-8OIay7SsBN_U5w")  # Telegram bot token
CHAT_ID = os.getenv("1211267625")  # Mesaj göndereceğin grup/kanal ID
